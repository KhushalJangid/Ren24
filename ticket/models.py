...
# from .functions import generate_customticket
...
class CustomTicket(models.Model):
    ...
    def generate_customticket(self)->bytes:
        ...
        draw.text((350, 25), f"Booking Id: {id}", fill="white", font=font_small)
        draw.text((350, 70), f"{self.name} ", fill="black", font=font)
        draw.text((350, 170),f"{self.email}", fill="white", font=font_medium)
